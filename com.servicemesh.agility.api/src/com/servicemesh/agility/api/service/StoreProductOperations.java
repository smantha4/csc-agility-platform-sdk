...
public interface StoreProductOperations {
    ...
    public void getOrderApprovers(Item launchItem, int locationId, PublishRequest request, 
            StringBuilder users, StringBuilder groups) throws Exception;
    public void getDeployApprovers(Item launchItem, int locationId, PublishRequest request, 
            StringBuilder users, StringBuilder groups) throws Exception;
