...
public interface IContainer {
	...
	public Container addSecurityAccessRight(Container container, int security_id, int rights_id, AccessRight accessright) throws Exception;
	public Task deleteSecurityAccessRight(Container container, int security_id, int rights_id, int accessright_id) throws Exception;
