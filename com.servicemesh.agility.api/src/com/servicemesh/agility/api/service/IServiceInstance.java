...
public interface IServiceInstance
{
     ...
     *
     * @param instance
     *            An instance of com.servicemesh.agility.api.ServiceInstance
     * @throws Exception
     */
    ...
    /**
     * If the service instance is an degraded state due to different reasons like not being able to register with load balancer
     * service, provides the ability to acknowledge the error and transitions the state to running.
     *
     * @param instance
     *            A service instance of com.servicemesh.agility.api.ServiceInstance
     * @throws Exception
     */
