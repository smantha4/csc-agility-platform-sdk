...
public interface IVolume {
	...
	/**
	 * Extend the identified logical volume attached to the specified instance
	 * by one disk.
	 * 
	 * @param instance The instance to which the logical volume is attached.
	 * @param volumeId The ID of the volume to extend.
	 * 
	 * @return The scheduled task which will perform the steps necessary to extend
	 *         the volume.
	 * @throws Exception
	 */
