...
public interface ICloud {
	 ...
	 * @param cloud The cloud provider to sync
	 ...
	 * Request a sync of the cloud provider.
	 * @param cloud The cloud provider to sync
	 * @param exclusions a comma-separated list of sync aspects to not perform (currently supported are "images" and "repo")
	 * @return Returns a task reference that can be used to poll for completion.
	 * @throws Exception
	 */
	...
	/**
	 * Return a list of effective models for the cloud.  Optional search 
	 ...
	 * @param cloudId
	 * @param subscription network subscription
	 * @param context
	 * @throws Exception
	 */
