...
/**
 * Exposes additional operations to manage the following types from
 * com.servicemesh.agility.api package:
 * Project, Environment, Topology Template, Instance 
 */
public interface INetwork {
	 ...
	 * @param asset The network to be deleted
	 * @param parent The parent asset
	 * @param release If true, release network resources
	 ...
	 * @param network The network where the address is allocated from
	 * @param nic The NIC where the address will be allocated to
	 * @param address The address being reserved
	 ...
	 * @param network The network where the address is de-allocated from
	 * @param nic The NIC where the address will be de-allocated from
	 * @return NetworkInterface The updated NIC
	 * @throws Exception
	 */
	 ...
	 * @param network The network where the address might reside
	 * @param address The address to remove if available
	 * @throws Exception
	 */
	 ...
	 * @param network The network where the address is allocated from
	 * @param nic The NIC where the address will be allocated to
	 * @param instance The instance the address is being reserved for - can be null
	 * @return NetworkInterface The updated NIC
	 * @throws Exception
	 */
	 ...
	 * @param network The network where the address is released from
	 * @param nic The NIC where the address will be released from
	 * @return NetworkInterface The updated NIC
	 * @throws Exception
	 */
	 ...
	 * @param instance Instance to assign the address too
