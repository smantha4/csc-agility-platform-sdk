...
public interface IPort {
	 ...
	 * @param networkInterfaceId Network interface identifier
	 ...
	 * @param instanceId Instance identifier
	 * @param networkInterfaceId Identifier for network interface having a port to detach
	 * @return A task handle that can be polled for task completion.
	 * @throws VMException
	 */
	 ...
	 * @param asset The port to be deleted
	 * @param parent The containing asset
	 * @param release if true, release port resources
	 * @return A task handle that can be polled for task completion.
	 * @throws Exception
	 */
