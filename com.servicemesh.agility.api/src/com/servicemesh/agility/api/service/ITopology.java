...
public interface ITopology<T> {
	 ...
	 * @param topology Topology to be deleted
	...
	/**
	 * Finalizes the delete request of a Topology. To be used only when all 
	 * templates associated to a topology have been deleted.
	 * 
	 * @param parentTask Parent task of the delete request
	 * @param topology Topology to be deleted
	 * @param isParentContext If true, aspect context of the parent is used
