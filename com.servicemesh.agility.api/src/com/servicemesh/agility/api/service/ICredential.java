...
public interface ICredential {
	 ...
	 * @param id the id of the credential to fetch
	 * @param fieldName the name of the field to fetch.  Valid values are
	 ...
	 * @param fieldName the field to update.  Valid values are "privateKey" 
	 * and "publicKey".
	 * @param fieldValue the value to store into the field
	 * @throws Exception
	 */
