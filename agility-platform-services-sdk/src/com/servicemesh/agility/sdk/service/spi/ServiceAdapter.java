...
public abstract class ServiceAdapter implements BundleActivator {
   ...
   private Map<String,IValueProvider> _providers = new HashMap<String,IValueProvider>();
	...
	/**
	 * Required meta-data to describe capabilities of the adapter/service provider. The returned RegistrationRequest
	 * is sent to the agility platform and the onRegistration method called with the response.
	 * 
	...
	/**
	 * Provides any information requested by the adapter during the registration request including
	...
	/**
	 * @return
	 * An optional interface that implements hooks in service instance lifecycle for service instances
	 * dependent on the service.
	 */
	public IServiceInstanceLifecycle getServiceInstanceLifecycleOperations() { return null; }
	...
	/**
	 * @return
	 * A required interface to manage the lifecycle of bindings (service instances) to the 
	 * service provider.
	 */
	...
	/**
	 * @return
	 * An optional interface to manage the lifecycle of connections to the 
	 * service provider.
	 */
	 ...
	 * receiving CRUD event messages for when it builds it's initial registration message.
	 */
	public IAssetLifecycle getAssetNotificationOperations() { return new AssetOperations();}
	...
	public void start(BundleContext context) throws Exception 
	{
		try
		{
			...
			_asyncTracker = new ServiceTracker(context, AsyncService.class.getName(), new AsyncTracker(this,context, Version.SDK_VERSION));
			_asyncTracker.open();
		}
		catch(Throwable t)
		{
	...
	private <REQ extends Request, RSP extends Response> void register(Class<REQ> reqClass, final Function<REQ,Promise<RSP>> handler)
	{
	...
	private void register()
	{
		...
		register(ServiceProviderPreCreateRequest.class,new Function<ServiceProviderPreCreateRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceProviderPostCreateRequest.class,new Function<ServiceProviderPostCreateRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceProviderPreUpdateRequest.class,new Function<ServiceProviderPreUpdateRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceProviderPostUpdateRequest.class,new Function<ServiceProviderPostUpdateRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceProviderPreDeleteRequest.class,new Function<ServiceProviderPreDeleteRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceProviderPostDeleteRequest.class,new Function<ServiceProviderPostDeleteRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceProviderStartRequest.class,new Function<ServiceProviderStartRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstanceValidateRequest.class,new Function<ServiceInstanceValidateRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstanceProvisionRequest.class,new Function<ServiceInstanceProvisionRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstanceReconfigureRequest.class,new Function<ServiceInstanceReconfigureRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstanceStartRequest.class,new Function<ServiceInstanceStartRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
      ...
      register(ServiceInstanceReleaseRequest.class,new Function<ServiceInstanceReleaseRequest,Promise<ServiceProviderResponse>>()
      {
         @Override
		...
		register(ServiceInstancePreProvisionRequest.class,new Function<ServiceInstancePreProvisionRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePostProvisionRequest.class,new Function<ServiceInstancePostProvisionRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePreStartRequest.class,new Function<ServiceInstancePreStartRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePostStartRequest.class,new Function<ServiceInstancePostStartRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePreStopRequest.class,new Function<ServiceInstancePreStopRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePostStopRequest.class,new Function<ServiceInstancePostStopRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePreRestartRequest.class,new Function<ServiceInstancePreRestartRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePostRestartRequest.class,new Function<ServiceInstancePostRestartRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePreReleaseRequest.class,new Function<ServiceInstancePreReleaseRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ServiceInstancePostReleaseRequest.class,new Function<ServiceInstancePostReleaseRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ConnectionPostCreateRequest.class,new Function<ConnectionPostCreateRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ConnectionPostUpdateRequest.class,new Function<ConnectionPostUpdateRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
		...
		register(ConnectionPostDeleteRequest.class,new Function<ConnectionPostDeleteRequest,Promise<ServiceProviderResponse>>()
		{
			@Override
