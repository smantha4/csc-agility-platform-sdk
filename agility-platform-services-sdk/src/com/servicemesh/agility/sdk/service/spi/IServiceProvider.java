...
/**
 * Provides a standard set of operations for managing the service provider. Additionally provides lifecycle callouts on 
 * changes to the service provider configuration/definition.
 */
public interface IServiceProvider {
    ...
    * @return Promise to results on completion..
	...
	/**
	 * Called after successful configuration of the service provider. An adapter may require some sync of the new
	 * configuration with the actual service provider.
	 * 
	 * @param request Contains the initial configuration.
    * @return Promise to results on completion..
    ...
    * @return Promise to results on completion..
	 ...
	 * 
	 * @param request Specifies the desirned configuration. 
    * @return Promise to results on completion..
	 */	
	public Promise<ServiceProviderResponse> sync(ServiceProviderSyncRequest request);
	
	/**
	 * Called from Agility platform to request that the service provider be started. This may not apply to
	 * many service providers. In this case the adapter should just indicate successful completion of the request.
	 * 
	 * @param request Specifies the desirned configuration. 
    * @return Promise to results on completion..
	 */		
	...
	/**
	 * Called from Agility platform to request that the service provider be stopped. This may not apply to
	 * many service providers. In this case the adapter should just indicate successful completion of the request.
	 * 
	 * @param request Specifies the desirned configuration. 
    * @return Promise to results on completion..
