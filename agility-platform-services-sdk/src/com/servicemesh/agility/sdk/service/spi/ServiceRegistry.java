...
public class ServiceRegistry {
	...
	/**
	 * Returns the AsyncService that can process com.servicemesh.agility.api
	 * Requests like CreateRequest and GetRequest. Blocks until the
	 ...
	 * @param name The name attribute of a service provider type
	 */
	public AsyncService lookupServiceByProviderType(String name)
	{
		...
		return (references != null && references.length > 0) ?
			(AsyncService)_context.getService(references[0]) : null;
	}
}
