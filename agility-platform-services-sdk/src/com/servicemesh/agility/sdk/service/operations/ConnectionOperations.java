...
public class ConnectionOperations implements IConnection {
	...
	public Promise<ServiceProviderResponse> preCreate(
			ConnectionPreCreateRequest request) {
	...
	@Override
	public Promise<ServiceProviderResponse> postCreate(
			ConnectionPostCreateRequest request) {
		ServiceProviderResponse response = new ServiceProviderResponse();
		response.setStatus(Status.COMPLETE);
		return Promise.pure(response);
	}
	...
	public Promise<ServiceProviderResponse> preUpdate(
			ConnectionPreUpdateRequest request) {
		ServiceProviderResponse response = new ServiceProviderResponse();
		response.setStatus(Status.COMPLETE);
		return Promise.pure(response);
	}
	...
	@Override
	public Promise<ServiceProviderResponse> postUpdate(
			ConnectionPostUpdateRequest request) {
		ServiceProviderResponse response = new ServiceProviderResponse();
		response.setStatus(Status.COMPLETE);
		return Promise.pure(response);
	}
	...
	@Override
	public Promise<ServiceProviderResponse> preDelete(
			ConnectionPreDeleteRequest request) {
		ServiceProviderResponse response = new ServiceProviderResponse();
		response.setStatus(Status.COMPLETE);
		return Promise.pure(response);
	}
	...
	@Override
	public Promise<ServiceProviderResponse> postDelete(
			ConnectionPostDeleteRequest request) {
		ServiceProviderResponse response = new ServiceProviderResponse();
		response.setStatus(Status.COMPLETE);
		return Promise.pure(response);
	}
