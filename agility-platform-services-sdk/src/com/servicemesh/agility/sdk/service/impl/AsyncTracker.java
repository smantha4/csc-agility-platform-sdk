...
public class AsyncTracker implements ServiceTrackerCustomizer {
	...
	public Object addingService(ServiceReference ref) 
	{
		...
		if( serviceType != null && serviceType.equals("service") &&
			serviceProviderType != null && serviceProviderType.equals("framework") &&
			version != null && version.toString().equals(_version))
		{
