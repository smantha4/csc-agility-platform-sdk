...
{
    /** Class wide logger. */
    private final static Logger s_logger = Logger.getLogger(WorkReactorSimpleExample.class);
    ...
    /**
     * A Work object that will keep resubmitting itself until a counter reaches a threshold, at which point it resets the counter
     * and submits a WorkHandler.
     */
    ...
    /**
     * A WorkHandler that will keep resubmitting itself until a counter reaches a threshold, at which point it shuts down the
     * reactor.
     */
    ...
    public static void main(String[] args)
    {
        ...
        s_logger.info("WorkReactor has terminated: cycle count = " + reactor.getWorkReactor().getCycleCount());
        System.exit(0);
    }
}
