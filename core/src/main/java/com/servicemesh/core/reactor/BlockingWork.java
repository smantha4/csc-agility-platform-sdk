...
/**
 * Work class that, when firing, waits until it is externally signaled to proceed, and also allows other threads to know when the
 * workFire method has started. This will cause the reactor that is firing it to block until the signal is received. Useful for
