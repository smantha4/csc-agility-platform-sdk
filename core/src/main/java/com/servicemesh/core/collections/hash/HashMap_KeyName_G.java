...
/**
 * HashMap_KeyName_G is an efficient array oriented hash map with _KeyType_ keys and Generic values.
 */
public class HashMap_KeyName_G<V> extends AbstractHash_KeyName_ implements Map_KeyName_G<V>
{
    /** Array holding the values to be associated with keys. */
    protected Object[] m_values;

    /**
     * Constructs an empty HashMap_KeyName_G with default capacity and the default load factor
     */
    ...
    /**
     * Constructs an empty HashMap_KeyName_G with the specified initial capacity and the default load factor.
     *
    ...
    /**
     * Constructs an empty HashMap_KeyName_G with the specified initial capacity and load factor.
     *
     * @param initialCapacity
     *            the initial capacity.
     * @param loadFactor
     ...
     *                check for a -1 result, and optionally call V getEntryValue(int entry).
     */
