...
public class DistributedMutex {
	...
	private final static ThreadLocal<ConcurrentHashMap<String,LockEntry>> _locks = new ThreadLocal<ConcurrentHashMap<String,LockEntry>>();
     ...
     * @param path The ZooKeeper path that serves as the mutex identifer, e.g., "/agility/cloud/lock".
