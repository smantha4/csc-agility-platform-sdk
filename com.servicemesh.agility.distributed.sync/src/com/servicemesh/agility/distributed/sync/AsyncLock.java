...
import com.servicemesh.agility.distributed.sync.LockListener;
import com.servicemesh.agility.distributed.sync.WriteLock;
...
public class AsyncLock {
     ...
     * @param path The ZooKeeper path that serves as the lock identifier, e.g. "/agility/my-service/my-service-instance-name/lock".
     * @return A failed Promise if unable to obtain lock. Otherwise, a Promise that can invoke its asynchronous operation via a compositional method such as flatMap().
     */
