...
public class DistributedNode {
	...
	public static String getID() { return _nodeID; }
	public static String getLeaderID() { return _leaderID; }
	public static void setLeaderID(String leaderID) { _leaderID = leaderID; }
	public static boolean isLeader() { return (_leaderID != null && _nodeID.equals(_leaderID)); }
