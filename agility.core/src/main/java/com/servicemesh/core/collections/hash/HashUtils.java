...
public class HashUtils
{
     ...
     * critical because our hash tables use power-of-two length arrays, that otherwise encounter collisions for hashCodes that do
     * not differ in lower bits. Note: Null keys always map to hash 0, thus index 0.
     * 
     * @param h
     *            The value for which the hash code is to be supplemented
    ...
    /**
     * Computes the hash code for the given long value. This is the same hash code calculation as in java.lang.Long.
     * 
     * @param value
     *            The value for which the hash code is to be computed.
    ...
    /**
     * Computes the hash code for the given int value. This is the same hash code calculation as in java.lang.Integer.
     * 
     * @param value
     *            The value for which the hash code is to be computed.
     * @return the hash code value.
    ...
    /**
     * Computes the hash code for the given short value. This is the same hash code value as used by java.lang.Short.
     * 
     * @param value
     *            The value for which the hash code is to be computed.
     * @return the hash code value.
    ...
    /**
     * Computes the hash code for the given byte value. This is the same hash code calculation as used for java.lang.Byte.
     * 
     * @param value
     *            The value for which the hash code is to be computed.
     * @return the hash code value.
    ...
    /**
     * Computes the hash code for the given double value. This is the same hash code calculation as used by java.util.Double.
     * 
     * @param value
     *            The value for which the hash code is to be computed.
     * @return the hash code value.
     ...
     *            expected number of initial entries to support.
     ...
     * 
     * @param a
     *            The first part of the two part key.
     * @param b
     *            The second part of the two part key.
     ...
     * 
     * @param a
     *            The first part of the three part key.
     * @param b
     *            The second part of the three part key.
     * @param c
     *            The second part of the three part key.
    ...
    /**
     * Used in building the hash code for a multi-part key. The location, current hash code and the next value are given. The
     * function returns the new hash code, which can be used for a subsequent call to one of the build methods or as the hash code
     * for the multi-part key, once all parts have been considered.
     * 
     * @param loc
     *            The location of the given value in the multi-part key.
     * @param code
     *            The hash code computed thus far.
     * @param value
     *            The next value to be used in the hash code computation..
