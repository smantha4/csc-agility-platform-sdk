...
public class HashMapGTest
{
    ...
    public void testSimplePut()
    {
        ...
        assertKeyEquals("Map keys should contain new value", Types.get_KeyName_For(100), (_KeyType_) m_map.getKeys()[0]);
        assertValueEquals("Map values should contain new value", Types.get_ValueName_For(200),
