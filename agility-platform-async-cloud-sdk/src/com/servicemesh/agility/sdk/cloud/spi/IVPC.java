...
public interface IVPC {
	...
	public ICancellable vpnGatewayConnectionCreate(VPNGatewayConnectionCreateRequest request, ResponseHandler<VPCResponse> handler);
	public ICancellable vpnGatewayConnectionDelete(VPNGatewayConnectionDeleteRequest request, ResponseHandler<VPCResponse> handler);
	...
	public ICancellable vpnConnectionState(VPNConnectionStateRequest request, ResponseHandler<VPNConnectionStateResponse> handler);
	...
	public ICancellable vpnGatewayAttachments(VPNGatewayAttachmentsRequest request, ResponseHandler<VPNGatewayAttachmentsResponse> handler);
