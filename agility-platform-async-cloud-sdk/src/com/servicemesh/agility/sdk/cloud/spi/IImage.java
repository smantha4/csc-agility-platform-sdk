...
/**
 * Defines operations around image management within the cloud provider. Generally required
 * functionality of any cloud adapter.
 */
public interface IImage
{
	 ...
	 * 
	 * @param request Specifies the image to delete.
	...
	/**
	 * Called to clone an existing virtual machine to a new virtual machine template/image
	 * from which new virtual machines may be instantiated.
	 * 
	 * @param request Specifies the virtual machine to clone.
	 * @param handler Interface to asynchronously signal completion (or error) of the requested operation.
	 * @return An instance of ICancellable which can be used by the platform to cancel the pending operation.
	 */
