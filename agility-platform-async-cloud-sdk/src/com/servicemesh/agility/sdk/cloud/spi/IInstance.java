...
public interface IInstance {
	...
	/**
	 * Called by the platform to initiate provisioning of a VM. This generally corresponds to a clone
	 * image operation within the cloud provider. On completion the adapter should populate instance
	 * attributes such as:
	 * 
	 ...
	 * - mac address
	 * 
	 * @param request Specifies the virtual machine settings
	...
	/**
	 * Called after the initial create/clone operation to boot the image. On completion the adapter
	 * should populate instance attributes such as:
	 * 
	 * - state
	 * - hostname
	 * - IP address
	 * 
	 * @param request Specifies the virtual machine to boot.
	 * @param handler Interface to asynchronously signal completion (or error) of the requested operation.
	 * @return An instance of ICancellable which can be used by the platform to cancel the pending operation.
	 */
	 ...
	 * 
	 * @param request Specifies the virtual machine to stop.
	 * @param handler Interface to asynchronously signal completion (or error) of the requested operation.
	 * @return An instance of ICancellable which can be used by the platform to cancel the pending operation.
	 */
	 ...
	 * 
	 * @param request Specifies the virtual machine to start.
	 * @param handler Interface to asynchronously signal completion (or error) of the requested operation.
	 * @return An instance of ICancellable which can be used by the platform to cancel the pending operation.
	 */
	 ...
	 * a physical server.
	 * 
	 * @param request Specifies the virtual machine to reboot.
	 * @param handler Interface to asynchronously signal completion (or error) of the requested operation.
	 * @return An instance of ICancellable which can be used by the platform to cancel the pending operation.
	 */
	 ...
	 * 
	 * @param request Specifies the virtual machine to release.
	 * @param handler Interface to asynchronously signal completion (or error) of the requested operation.
	 * @return An instance of ICancellable which can be used by the platform to cancel the pending operation.
	 */
