...
{
	/**
	 * Called to create a new ssh key that is used by the cloud provider to authenticate logins to virtual
	 * machines created with the specified key. The call typically returns a public/private keypair. The 
	 * public key is added to the ssh configuration of the virtual machine to enable authentication via
	 * the associated private key.
	 * 
	 * @param request Specifies the name assigned to the key.
