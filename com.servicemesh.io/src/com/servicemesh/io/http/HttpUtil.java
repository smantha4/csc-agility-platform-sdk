...
/**
 * This abstract class contains utility methods for the HTTP and supporting libraries.  All methods should be
 * defined as static.
 * 
 * @author henry
 *
...
public abstract class HttpUtil implements Serializable {
    ...
    /**
     * This method will filter values of key words that could be considered password or key information.  This
     * hides values in a string that may be written to a log file.
     * 
     * @param str Text that may have security-type key words
     * 
    ...
    /**
     * This method will take an XML string along with a JAXB context object and convert the XML to a domain object.
     * If the namespace parameter is provided, the parser will be configured to be namespace aware, i.e. expect the 
     * XML to contain a namespace prefix.
     * 
     * @param xml XML string to be converted
     * @param namespace Value of the namespace prefix in the XML file
     * @param context JAXB context from which the domain object can be created
     * 
     * @return Object - this is a generic object that will need to be cast by the consumer of this method
     * 
     * @throws HttpClientException - wraps exceptions that may be thrown by the parsing and conversion process
     */
