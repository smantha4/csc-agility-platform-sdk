    ...
    public void remove(String key)
    {
        if (key != null)
        {
            ...
            if (param != null)
            {
                ...
                {
                    logger.warn("The parameter key '" + key.toLowerCase()
                            + "' was not found in the case map.  This was unexpected and nothing was removed.");
                }
                ...
                {
                    logger.warn("The parameter key '" + key
                            + "' was not found as a valud of the order map.  This was unexpected and nothing was removed from the ordermap.");
                }
            }
            else
            {
