...
{
    /** Class wide logger. */
    private final static Logger s_logger = Logger.getLogger(EchoClient.class);

    /** Displays a usage message. */
    private static void usage(String msg)
    {
        s_logger.error(msg + "\n" + "usage: java " + EchoClient.class.getName() + " [host=\"localhost\"]" + " [port=6789]"
                + " [msg=\"ECHO\"]");
    }
    ...
    public void init()
    {
        ...
        Connector c = new Connector(m_ioReactor, new EchoConnectorAdapter("EchoClientAcceptor", m_host, m_port));
        c.connect();
    }
    ...
    public static void main(String[] args)
    {
        ...
        s_logger.info("IOReactor has terminated: cycle count = " + client.getIOReactor().getCycleCount());
        System.exit(0);
    }
}
