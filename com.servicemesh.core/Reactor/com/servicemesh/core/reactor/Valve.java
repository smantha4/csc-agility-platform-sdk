...
/**
 * A Valve represents a unit of work to be done during a pass through an IOReactor duty cycle.
 */
public class Valve implements ValveHandler
{
    ...
    /**
     * The ValveHandler that will be invoked the next time through the reactor loop.
     */
     ...
     *
     * @param handler
     *            the ValveHandler that will be invoked when the valve is ripe.
     */
    public Valve(IOReactor ioReactor, SelectableChannel channel, ValveHandler handler)
    {
     ...
     *
     * @param ioReactor
     *            the IOReactor that will control this Valve
     */
     ...
     *
     * @param channel
     *            the channel that will be managed by this Valve.
     */
     ...
     *
     * @param handler
     *            the ValveHandler that will be invoked via this Valve.
     */
    ...
    /**
     * This is a stub method that should be overridden in a subclass, or the Valve class can be provided a ValveHandler as a
     * target (much like Thread can be either be subclassed with run() overridden or it can be provided a Runnable).
     *
     * @param valve
     *            the Valve that is ready for I/O.
     * @param selectedKey
