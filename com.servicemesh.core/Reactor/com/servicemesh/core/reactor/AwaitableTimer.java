...
/**
 * Abstract base class for a timer that another thread needs to ensure has completed before continuing. If the same AwaitableTimer
...
public abstract class AwaitableTimer extends Timer
{
    ...
    /**
     * The method that will invoke an overridden doTimer method. While doTimer returns a resubmission time then the timer will be
     * resubmitted and the timer is not considered to have been completed yet.
     */
    @Override
