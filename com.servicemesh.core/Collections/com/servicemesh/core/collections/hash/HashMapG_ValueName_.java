...
/**
 * HashMapG_ValueName_ is an efficient array oriented hash map with Generic keys and _ValueType_ values.
 */
public class HashMapG_ValueName_<K> extends AbstractHashG<K> implements MapG_ValueName_<K>
{
    /** Array holding the values to be associated with keys. */
    protected _ValueType_[] m_values;

    /**
     * Constructs an empty HashMapG_ValueName_ with default capacity and the default load factor
     */
    ...
    /**
     * Constructs an empty HashMapG_ValueName_ with the specified initial capacity and the default load factor.
     *
    ...
    /**
     * Constructs an empty HashMapG_ValueName_ with the specified initial capacity and load factor.
     *
     * @param initialCapacity
     *            the initial capacity.
     * @param loadFactor
     ...
     *                -1 result, and optionally call _ValueType_ getEntryValue(int entry).
     */
