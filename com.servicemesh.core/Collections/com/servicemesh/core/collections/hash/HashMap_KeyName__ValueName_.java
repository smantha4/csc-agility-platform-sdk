...
/**
 * HashMap_KeyName__ValueName_ is an efficient array oriented hash map with _KeyType_ keys and _ValueType_ values.
 */
public class HashMap_KeyName__ValueName_ extends AbstractHash_KeyName_ implements Map_KeyName__ValueName_
{
    /** Array holding the values to be associated with keys. */
    protected _ValueType_[] m_values;

    /**
     * Constructs an empty HashMap_KeyName__ValueName_ with default capacity and the default load factor
     */
    ...
    /**
     * Constructs an empty HashMap_KeyName__ValueName_ with the specified initial capacity and the default load factor.
     *
    ...
    /**
     * Constructs an empty HashMap_KeyName__ValueName_ with the specified initial capacity and load factor.
     *
     * @param initialCapacity
     *            the initial capacity.
     * @param loadFactor
     ...
     *                if the key is not found in the table. To avoid the use of exceptions, call int getEntry(_KeyType_ key),
     *                check for a -1 result, and optionally call _ValueType_ getEntryValue(int entry).
     */
    ...
    public _ValueType_[] getValues(_ValueType_[] dst)
    {
        ...
        {
            dst = (_ValueType_[]) Array.newInstance(dst.getClass().getComponentType(), m_size);
        }
        int count = 0;
