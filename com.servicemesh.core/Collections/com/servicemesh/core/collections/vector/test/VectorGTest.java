...
public class VectorGTest
{
    ...
    protected void checkValues(String msg, int vectorStart, int testStart, int length)
    {
        ...
        {
            assertTrue(msg, Comparators.ObjectAsc.equals(m_vector.get(i + vectorStart), m_testValues[i + testStart]));
        }
    }
    ...
    public void testFillA()
    {
        ...
        {
            assertTrue("Full fill value wrong", Comparators.ObjectAsc.equals(m_vector.get(i), value));
        }
    }
    ...
    public void testFillB()
    {
        ...
        {
            assertTrue("Partial fill value wrong", Comparators.ObjectAsc.equals(m_vector.get(i), value));
        }
