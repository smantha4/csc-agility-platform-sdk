...
public class Vector_ValueName_Test
{
    ...
    public void testResetA()
    {
        ...
        assertEquals("Cleared vector has non-zero size", 0, m_vector.getSize());
    }
    ...
    public void testResetB()
    {
        ...
        assertEquals("Re-cleared vector has non-zero size", 0, m_vector.getSize());
        assertEquals("Doubling capacity didn't work", (newCapacity), m_vector.getCapacity());
    }

    protected void checkValues(String msg, int vectorStart, int testStart, int length)
    {
        for (int i = 0; i < length; i++)
        {
            assertTrue(msg, Comparators._ValueName_Asc.equals(m_vector.get(i + vectorStart), m_testValues[i + testStart]));
        }
    }
    ...
    public void testAddA()
    {
        ...
        assertEquals("Setup resulted in wrong length", TEST_SIZE, m_vector.getSize());
        checkValues("Individual adds result in wrong values", 0, 0, TEST_SIZE);
    }
    ...
    public void testAddB()
    {
        ...
        assertEquals("Add of vector resulted in wrong length", TEST_SIZE * 2, m_vector.getSize());
        checkValues("Vector add results in wrong values", TEST_SIZE, 0, TEST_SIZE);
    }
    ...
    public void testAddC()
    {
        ...
        assertEquals("Add of sub-vector resulted in wrong length", (TEST_SIZE * 2) - 2, m_vector.getSize());
        checkValues("Subvector add results in wrong values", TEST_SIZE, 1, TEST_SIZE - 2);
    }
    ...
    public void testFillA()
    {
        ...
        {
            assertTrue("Full fill value wrong", Comparators._ValueName_Asc.equals(m_vector.get(i), value));
        }
    }
    ...
    public void testFillB()
    {
        ...
        {
            assertTrue("Partial fill value wrong", Comparators._ValueName_Asc.equals(m_vector.get(i), value));
        }
    ...
    public void testInsertA()
    {
        ...
        assertEquals("Length wrong after single value insert", TEST_SIZE + 1, m_vector.getSize());
    }
    ...
    public void testInsertB()
    {
        ...
        assertEquals("Length wrong after full vector insert", TEST_SIZE * 2, m_vector.getSize());
        checkValues("Full insert overwrote start of vector", 0, 0, position);
        checkValues("Full insert values wrong", position, 0, TEST_SIZE);
        checkValues("Full insert overwrote end of vector", position + TEST_SIZE, position, TEST_SIZE - position);
    }
    ...
    public void testInsertC()
    {
        ...
        assertEquals("Length wrong after partial vector insert", TEST_SIZE + end - start, m_vector.getSize());
        checkValues("Partial insert overwrote start of vector", 0, 0, position);
        checkValues("Partial insert values wrong", position, start, end - start);
        checkValues("Partial insert overwrote end of vector", position + end - start, position, TEST_SIZE - position);
    }
    ...
    public void testRemoveA()
    {
        ...
        assertEquals("Length wrong after single remove", TEST_SIZE - 1, m_vector.getSize());
        checkValues("Single remove tainted start of vector", 0, 0, position - 1);
        checkValues("Single remove tainted end of vector", position, position + 1, TEST_SIZE - position - 1);
    }
    ...
    public void testRemoveB()
    {
        ...
        assertEquals("Length wrong after remove", TEST_SIZE - (end - start), m_vector.getSize());
        checkValues("Remove tainted start of vector", 0, 0, start - 1);
        checkValues("Remove tainted end of vector", start, end, TEST_SIZE - end);
    }
    ...
    public void testSortC()
    {
        ...
        checkValues("Partial sort overwrote start of vector", 0, 0, start);
        checkValues("Partial sort overwrote end of vector", end, end, TEST_SIZE - end);
    }
