...
public class Search_ValueName_
{
    ...
    {
        return binary(values, 0, values.length, value, Comparators._ValueName_Asc);
    }
     ...
     *         point (suitable for passing to the insert methods).
     */
    public static int binary(_ValueType_[] values, _ValueType_ value, Cmp_ValueName_ cmp)
    {
     ...
     *         point (suitable for passing to the insert methods).
     */
    public static int binary(_ValueType_[] values, int offset, int length, _ValueType_ value)
    {
        return binary(values, offset, length, value, Comparators._ValueName_Asc);
    }
     ...
     *         point (suitable for passing to the insert methods).
     */
    public static int binary(_ValueType_[] values, int offset, int length, _ValueType_ value, Cmp_ValueName_ cmp)
    {
        int low = offset;
