...
public class AsyncService {
    ...
    private final static Logger s_logger =
        Logger.getLogger(AsyncService.class);

    protected Reactor _reactor;

    protected AtomicLong nextRequestId = new AtomicLong(1L);

    protected HashMapLongHandlerInfo responseHandlers =
        new HashMapLongHandlerInfo();
        ...
        _reactor.workCreate(new WorkHandler() {
                public boolean workFire() {
                    ...
                    if (entry != -1) {
                        ...
                        s_logger.error("Response being dispatched but no handler registered: " +
